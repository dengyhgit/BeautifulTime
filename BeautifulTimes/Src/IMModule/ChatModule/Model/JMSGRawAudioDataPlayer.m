...
#import "JMSGRawAudioDataPlayer.h"

@interface JMSGRawAudioDataPlayer ()
...
@implementation JMSGRawAudioDataPlayer
...
static void AudioPlayerAQInputCallback(void *input, AudioQueueRef outQ, AudioQueueBufferRef outQB) {
    JMSGRawAudioDataPlayer *player = (__bridge JMSGRawAudioDataPlayer *)input;
