 ...
 */
- (void)inputTextViewDidBeginEditing:(JMSGMessageTextView *)messageInputTextView;

- (void)inputTextViewDidEndEditing:(JMSGMessageTextView *)messageInputTextView;

- (void)inputTextViewDidChange:(JMSGMessageTextView *)messageInputTextView;
/**
 *  输入框将要开始编辑
 *
 *  @param messageInputTextView 输入框对象
 */
- (void)inputTextViewWillBeginEditing:(JMSGMessageTextView *)messageInputTextView;
...
@property (strong, nonatomic) JMSGToolBar *toolbar;
