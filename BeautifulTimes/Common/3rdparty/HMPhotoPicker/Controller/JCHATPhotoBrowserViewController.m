...
- (void)viewWillAppear:(BOOL)animated {
  ...
  [_collectionView scrollToItemAtIndexPath:_currentIndex
...
- (void)setupCollectionView {
  ...
  [_collectionView registerNib:[UINib nibWithNibName:@"JCHATPhotoBrowserCollectionViewCell" bundle:nil]
...
- (NSIndexPath *)currentIndex {
  NSInteger itemIndex = _collectionView.contentOffset.x / _collectionView.frame.size.width;
